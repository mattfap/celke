...
<?= $this->Html->image('logo_buonny.png', ['class' => 'mb-4', 'alt' => 'Celke', 'width' => '200', 'height'=>'100']) ?>
...
<p class="text-center">
    <?= $this->Html->link(__('Cadastrar'), ['Controller' => 'Users', 'action' => 'cadastrar']) ?> - Esqueceu a senha?
</p>
